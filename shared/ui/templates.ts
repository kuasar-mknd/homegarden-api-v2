...
// Optimization: "Static Response Caching" for 404 page shell
// Avoids re-interpolating large CSS and HTML strings on every 404 request
...
export function getNotFoundPageHtml(path: string): string {
  ...
  return NOT_FOUND_PAGE_TEMPLATE.replace('{{PATH_PLACEHOLDER}}', safePath)
}
