...
// Optimization: Split template to avoid repeated large string replacements
// "Performance benchmarks indicate that for large template strings with a single insertion point,
// splitting the template into static parts and joining them with the dynamic value is faster
// than using String.prototype.replace()."
