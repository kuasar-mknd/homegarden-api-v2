...
// Optimization: Select only fields required for UserProps to avoid fetching large JSON blobs (preferences) and password strings unless needed
const USER_SELECT = {
  id: true,
  email: true,
  firstName: true,
  ...
  createdAt: true,
  updatedAt: true,
  // preferences and password are explicitly excluded as they're not used in mapToUserProps/Entity
}
