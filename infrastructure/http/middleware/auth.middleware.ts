...
// Optimization: Select only required fields for auth context to minimize
// payload size and JSON parsing overhead on every request
const AUTH_USER_SELECT = {
  ...
  createdAt: true,
  updatedAt: true,
  // Exclude preferences (JSON) and password
}
