...
// Optimization: Select only necessary fields for context to minimize memory and DB overhead on every request
const AUTH_USER_SELECT = {
  ...
  createdAt: true,
  updatedAt: true,
  // password and preferences are explicitly excluded
}
