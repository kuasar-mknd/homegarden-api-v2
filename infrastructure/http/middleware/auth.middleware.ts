...
// Optimization: Shared selection object to reduce payload size and memory usage on every authenticated request
const AUTH_USER_SELECT = {
  ...
  // preferences: false, // Explicitly excluded (can be large JSON)
}
