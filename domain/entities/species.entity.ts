...
export class Species {
  ...
  get waterRequirement(): WaterRequirement | null | undefined {
    return this.props.waterRequirement
  }
  get lightRequirement(): LightRequirement | null | undefined {
    return this.props.lightRequirement
  }
  get defaultWateringDays(): number | null | undefined {
    return this.props.defaultWateringDays
  }
  get defaultFertilizeDays(): number | null | undefined {
    return this.props.defaultFertilizeDays
  }
