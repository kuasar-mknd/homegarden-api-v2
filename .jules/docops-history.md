...
| 2026-02-14 | CI Hardening & Arch Refinement | docs/ARCHITECTURE.md, docs/AI.md, docs/API.md, .github/workflows/ci.yml, .github/workflows/audit.yml | Aligned architecture docs with routing logic, clarified AI cost controls/auth stubs, enforced Node 24 in GH actions to fix deprecations |
