...
| 2026-01-22 | DocOps | README.md, docs/API.md, docker-compose.yml, .github/workflows/*.yml | Fixed GitHub Actions versions (v6->v4), aligned Docker setup to use `postgres` user, refined API Not Implemented docs. |
