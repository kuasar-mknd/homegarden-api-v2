...
| 2025-12-30 | DocOps | docs/AI.md, README.md, .github/workflows/audit.yml, .github/dependabot.yml, application/use-cases/dr-plant/diagnose-plant.use-case.ts | Updated AI docs with precise schemas, added security audit workflow and dependabot, fixed linting error. |
