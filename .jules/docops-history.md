...
| 2026-01-17 | Performance | infrastructure/database/repositories/user.prisma-repository.ts, infrastructure/http/middleware/auth.middleware.ts | Optimized User entity fetching to exclude unused JSON preferences and password fields. |
