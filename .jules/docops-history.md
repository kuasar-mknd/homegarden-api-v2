...
| 2026-01-20 | DocOps | README.md, docs/*, .github/workflows/*.yml, .env.example, biome.json | Standardized Env/DB config, updated API status, fixed CI versions, updated biome schema. |
